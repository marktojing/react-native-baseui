...
import {COLOR_BACKGROUND_BLACK_30, COLOR_BACKGROUND_WHITE_100,COLOR_TEXT_BLACK_30} from "../../index";
import PropTypes from "prop-types";
let width = Dimensions.get('window').width
export default class PV_Text_Login  extends React.Component{
    static defaultProps={
    ...
    render() {
        let {leftIcon,placeholder,rightText,secureTextEntry,onChangeText,rightIcon} = this.props;
        return(<View style={{height:52,width:width*343/375,marginHorizontal: 16,padding:8,borderRadius:8,backgroundColor:COLOR_BACKGROUND_WHITE_100,alignItems: 'center',flexDirection: 'row'}}>
            ...
            <TouchableOpacity style={{flex:1,alignItems: 'center',flexDirection: 'row'}} onPress={
                ...
                <TextInput  placeholder={placeholder}
                            ...
                            style={{flex:1,padding:8,fontSize:16,color:'black'}}
                />
                <Image style={{width:24,height:24,paddingHorizontal:8}} source={rightIcon} />
            </TouchableOpacity>
        </View>)
    }
}
